class ApiClient {
  ...
  async updateMemberRole(projectId, memberId, role) {
    return this.customFetch(
      `v1/projects/update-member-role/${projectId}/${memberId}`,
      {
        method: "post",
  ...
  async createSubTask(
    projectId,
    taskId,
    { title, isCompleted, remark = null },
  ) {
    return this.customFetch(
      `v1/subtasks/create-subtask/${projectId}/${taskId}`,
      {
        method: "post",
  ...
  async updateSubTask(
    ...
    taskId,
    id,
    { title, status: isCompleted, remark = null },
  ) {
    return this.customFetch(
      `v1/subtasks/update-subtask/${projectId}/${taskId}/${id}`,
      {
        method: "post",
        body: JSON.stringify({ title, isCompleted, remark }),
      },
  ...
  async deleteSubTask(projectId, taskId, id) {
    return this.customFetch(
      `v1/subtasks/delete-subtask/${projectId}/${taskId}/${id}`,
      {
        method: "post",
      },
    );
