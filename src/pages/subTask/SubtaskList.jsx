        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          {editMode && (
            <button
              ...
              className="block mt-2 text-sm text-gray-500 hover:text-red-500"
            >
              Cancel Edit
            </button>
          )}
        ...
        {subtasks.length === 0 ? (
          ...
          <ul className="space-y-4">
            {subtasks.map((subtask, i) => (
              <li
                key={subtask._id}
                className="w-full p-4 border rounded-lg bg-gray-50 shadow-sm flex flex-col lg:flex-row justify-between items-start lg:items-center"
              >
